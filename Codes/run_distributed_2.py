...
parser.add_argument('--cmd', default='python -u main_distributed_stale.py', help='Python script command. Eg: python -u train.py --epochs 10')
parser.add_argument('--model-tag', default='A_HGRU', help='Model Tag')
parser.add_argument('--num-ps', type=int, default=1, help='Number of Parameter Servers')
parser.add_argument('--num-workers', type=int, default=2, help='Number of Workers')
parser.add_argument('--save', default='./save_a', help='Save Location')
