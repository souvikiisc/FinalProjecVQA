...
def loss_score():
        ...
        rep_op = tf.contrib.opt.DropStaleGradientOptimizer(classify_optimizer, staleness=80)
...
if args.type == 'ps':
    ...
    with tf.device(tf.train.replica_device_setter(worker_device="/job:worker/task:{:d}".format(args.task_index),
        ...
        # sync_replicas_hook = rep_op.make_session_run_hook(is_chief=(args.task_index == 0))
